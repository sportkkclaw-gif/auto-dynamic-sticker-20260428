  ...
  return (
    <main style={{ padding: "2rem" }}>
      ...
      <div style={{ marginTop: "2rem", padding: "1.5rem", border: "1px solid #ddd", borderRadius: "8px", maxWidth: "600px" }}>
        <label style={{ display: "block", marginBottom: "0.5rem", fontWeight: "bold" }}>briefs.json</label>
        <textarea placeholder="輸入 LINE 簡報內容 JSON" style={{ width: "100%", padding: "0.75rem", borderRadius: "8px", border: "1px solid #ddd", marginBottom: "1rem", minHeight: "200px", fontFamily: "monospace" }} />
